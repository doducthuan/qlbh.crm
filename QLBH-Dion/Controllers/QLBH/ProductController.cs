    ...
    namespace QLBH_Dion.Controllers
    {
        ...
        public class ProductController : BaseController
        {
            ...
            public ProductController(IProductService _service, ICacheHelper cacheHelper )
            {
                service = _service;
            }
            [HttpGet]
            ...
            [HttpGet]
            [Route("api/ListLargeNumber")]
            public async Task<IActionResult> ListLargeNumber()
            {
                try
                {
                    var dataList = await service.ListLargeNumber();
                    if (dataList == null || dataList.Count == 0)
                    {
                        return NotFound();
                    }
