    ...
    namespace QLBH_Dion.Controllers
    {
        [Route("[controller]")]
        [ApiController]
        public class OrderAccountPaymentStatusController : BaseController
        {
            IOrderAccountPaymentStatusService service;
            public OrderAccountPaymentStatusController(IOrderAccountPaymentStatusService _service, ICacheHelper cacheHelper )
            {
                service = _service;
            }
            [HttpGet]
            ...
            [HttpPost]
            [Route("api/Add")]
            public async Task<IActionResult> Add([FromBody]OrderAccountPaymentStatus model)
            {
            ...
            [HttpPost]
            [Route("api/Update")]
            public async Task<IActionResult> Update([FromBody]OrderAccountPaymentStatus model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]OrderAccountPaymentStatus model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]OrderAccountPaymentStatus model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            [HttpGet]
            [Route("api/Count")]
            public int CountOrderAccountPaymentStatus()
            {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] OrderAccountPaymentStatusDTParameters parameters)
            {
                try
                {
